<?php
// MILELE - Premium Checkout Processor & STK Push Initiator (With Radar Redirect)
...
$checkout_id = ''; // Initialize for the JS radar below
            ...
            fetch('check_status.php?checkout_id=' + checkoutId)
                ...
                .then(data => {
                    if (data.status === 'funded') {
                        clearInterval(radar);
                        // Payment arrived! Instantly teleport to Victory Screen
