...
<script>
    // Grab the Safaricom checkout ID generated by PHP
    const checkoutId = "<?php echo isset($checkout_id) ? $checkout_id : ''; ?>";
            ...
            fetch('check_status.php?checkout_id=' + checkoutId)
                ...
                .then(data => {
                    if (data.status === 'funded') {
                        clearInterval(radar);
                        // Payment arrived! Instantly teleport them to their vault
